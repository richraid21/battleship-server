...
describe('Game Instance Unit Tests', () => {
    ...
    it('Should allow a player to join', () => {
        game.addPlayerConnection(1, sockets.player1)
    ...
    it('Should allow a second player to join', () => {
        game.addPlayerConnection(2, sockets.player2)
    ...
    it('Should accept a valid ship layout in pieces', () => {
        const ships = [
        ...
        game.setupPieces(1, ships)
        game.setupPieces(1, ships2)
        game.setupPieces(1, ships3)
    ...
    it('Should accept a valid ship layout as one call', () => {
    ...
    it('Should reject a guess from non-players turn', () => {
        game.guessLocation(2, {x: 1, y: 1})

        const reject = {"message": "Not your turn!", "payload": {}, "type": "GAME:GUESS:REJECT"}
        expect(player2).toBeCalledWith(reject)
    })

    it('Should accept a guess when it is the players turn', () => {
        game.guessLocation(1, {x: 1, y: 1})
    ...
    it('Should accept a guess and return a miss', () => {
        game.guessLocation(2, {x: 7, y: 9})
